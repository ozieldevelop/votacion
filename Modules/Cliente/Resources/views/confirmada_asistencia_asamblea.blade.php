...
<div id="register_form"  >
   ...
   <div class="form-row">
      ...
      <div class="form-group col-md12 col-sm-12">
        ...
        <label style="color:#ca6f4b"> No podr&aacute; ocupar cargos directivos los asociados que tengan entre s&iacute; parentesco por afinidad hasta el 2&#176; grado de consanguinidad hasta el 4&#176; grado.</label>
      </div>
   </div>
   <br>
