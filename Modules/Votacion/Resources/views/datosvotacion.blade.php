			  ...
			  <div class="animated fadeIn">
							...
							@foreach ($areas as $pape)
									<div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 our-team"> 
										<div class="card ">
																	<div class="card-header" style="background:#97a37b;text-align: center;color:white;font-size: 37px;font-weight: bold;">
														...
														<div  class="cuadritovotante col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12" style="cursor:pointer"  >
																<div class="card" >
																	...
																	<div class="card-body " id="collapseExample" style="text-align: center;">
																	  <p style="text-align: center;font-size: 37px;font-weight: bold;">{{ substr($dataaspirante->voto_nombre, 0, 10)  }} , {{ substr($dataaspirante->voto_apellido, 0, 10)   }}</p>
