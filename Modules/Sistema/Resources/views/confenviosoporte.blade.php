...
<div class="row ">
    ...
    <div class="col-md-12"  id="areaimportacion" style="display:none">
        ...
        <div class="card" >
            <div class="card-header bg-light resaltado">IMPORTAR LISTADO CSV (1 columnas una con el c&oacute;digos de asociado) </div>
            <div class="card-body" >
                <!-- dropzone  -->
                ...
                <form action="{{ route('generaReporte') }}" method="get" class="my-2">
                    {{ csrf_field() }}
                    <button class="btn btn-info" id="generar_boton" style="display: none">Generar Listado</button>
                </form>
    ...
    var config = {
        ...
        init: function () {
            this.on("success", function(file, responseText) {
                ...
                $('#generar_boton').css('display','block');
